...
def main_kubeflow_train_func():

    register_omegaconf_resolvers()
    cfg = compose(config_name="configs/sam2.1_training/sam2_frm22_bs1_trainval_not_trimmed_numpy_distributed.yaml")
...
#     name="jsbrq-cryoet-distributed",
#     train_func=main_kubeflow_train_func,
#     num_procs_per_worker="auto",
#     num_workers=4,
#     resources_per_worker={"nvidia.com/a100": "1"},
# )
