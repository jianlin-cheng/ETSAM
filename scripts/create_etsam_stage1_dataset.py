...
def create_etsam_stage1_dataset(images_output_dir, input_array, labels_output_dir, target_array):
...
def create_dataset(row_data, collection_dir, dataset_dir):    
    ...
    try:
        ...
        final_target_mask = cu.load_tomogram(os.path.join(run_dir, 'target_mask', f"{run_id}_target_mask.mrc"))
        ...
        create_etsam_stage1_dataset(images_output_dir, tomo.data, labels_output_dir, final_target_mask.data)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Create dataset for ETSAM Stage 1')
    ...
    parser.add_argument('--dataset-dir', type=str, default="data/etsam_stage1_dataset",
    ...
    for index, row in df.iterrows():
        ...
        create_dataset(row, collection_dir, dataset_dir)
