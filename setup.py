...
NAME = "ETSAM"
VERSION = "1.0"
DESCRIPTION = "ETSAM: Effectively Segmenting Membranes in cryo-Electron Tomograms"
URL = "https://github.com/jianlin-cheng/ETSAM"
AUTHOR = "Joel Selvaraj"
AUTHOR_EMAIL = "jsbrq@missouri.edu"
LICENSE = "MIT License"
...
try:
    ...
    cmdclass = {
        "build_ext": (
            BuildExtensionIgnoreErrors if BUILD_ALLOW_ERRORS else BuildExtension
        )
    }
except Exception as e:
    cmdclass = {}
